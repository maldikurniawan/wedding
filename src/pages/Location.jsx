...
const Location = () => {
  return (
    <div id="Lokasi" className="h-fit py-20 px-4 bg-white">
      {/* Title Section */}
      <div className="text-center mb-8">
        <h2 className="text-3xl md:text-6xl text-pink-500 font-cookie">
          Lokasi Acara
        </h2>
      </div>

      {/* Map Section */}
      <div className="relative w-full h-[300px] sm:h-[400px] md:h-[500px] sm:px-20 rounded-lg overflow-hidden">
        <iframe
